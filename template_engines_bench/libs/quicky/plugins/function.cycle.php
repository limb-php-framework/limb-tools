...
function quicky_function_cycle($params,&$quicky)
{
 ...
 {
  if (!isset($cycle_vars[$name]['values'])) {$quicky->trigger_error('cycle: missing \'values\' parameter'); return;}
 }
 else
 {
 ...
 else {$cycle_array = explode($cycle_vars[$name]['delimiter'],$cycle_vars[$name]['values']);}
